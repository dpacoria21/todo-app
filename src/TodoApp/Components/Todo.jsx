...
export const Todo = ({todo, handleDeleteTodo}) => {
    ...
    return (
        <div onDoubleClick={disabled} className={`relative ${state} h-full py-2 flex flex-col sm:flex-row gap-1 cursor-pointer items-center justify-between transition-all duration-300 px-5 rounded-sm hover:scale-110`}>
            {
